					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-4">
							...
							<div class="product-preview">
								<div class="big-image">
									<a href="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummy/450x600.png" data-toggle="lightbox">
										<img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummy/450x600.png" alt="" />
									</a>
								</div>
								<ul class="thumbs unstyled clearfix">
									<li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummy/450x600.png"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummy/450x600.png" alt="" /></a></li>
									<li><a href="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummy/450x600.png"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummy/450x600.png" alt="" /></a></li>
								</ul>
							</div>
						...
						<div class="col-xs-12 col-sm-8">
							<section class="product-details add-cart">
								<header class="entry-header">
									<h2 class="entry-title uppercase"><?php echo $data->title ?></h2>
								</header>
								<article class="entry-content">
									<figure>
										<span class="entry-price inline-middle">$<?php echo $data->price ?></span>
