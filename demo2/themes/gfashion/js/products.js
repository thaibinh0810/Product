jQuery(function($) {
	...
	function output_cookie()
	{
		...
		for ( var x in cookie )
		{
			...
			var $new = $('<tr> \
							...
							<td class="hidden-xs"><button type="butto" class="close" aria-hidden="true">×</button></td> \
						</tr>');
	...
	*/
	function update_cart_total()
	{
		...
		$('.shopcart-total .cart-eco-tax > .pull-right').text('$' + ecotax.toFixed(2));
		$('.shopcart-total .cart-shipping > .pull-right').text('$' + shipping.toFixed(2));
		$('.shopcart-total .cart-vat > .pull-right').text('$' + vat.toFixed(2));
		$('.shopcart-total .cart-total > .pull-right').text('$' + total.toFixed(2));
		$('.shopcart-total .cart-totalfinal > .pull-right').text('$' + totalfinal.toFixed(2));
	}
